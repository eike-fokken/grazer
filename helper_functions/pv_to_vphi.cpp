...
/** @brief OBSOLETE!
 *
 * A helper function to move turn a PVnode into a Vphinode.
 *
 ...
 *
 * - the id of the component to be moved to
 * - the exact name of the type the component is to be moved to
 */

// int main(int argc, char **argv) {
int main() {
  std::cout << "This executable is only here for inspiration. It does not work "
               "with the current layout of power initial conditions!"
            << std::endl;
  return 1;
  ...
  //   }
  //   bool found = false;
  //   for (auto &[compname, comptype] : input.items()) { // nodes and
  //   connections
