 ...
 *
 * - the relative or absolute path to the reference output file
 * - the name of the output filename (optional, defaults to "output")
 * - the name of the file to be generated by this helper function (optional,
 * defaults to "reference_discrepance.json")
 */
