 ...
 *
 * @param path_to_reference Relative or absolute path to the reference output
 * file
 * @param output_filename_trunk Default = "output"
 * @param computed_output Name of the file to be generated by this helper
 * function. Default = "reference_discrepance.json"
 *
 */
