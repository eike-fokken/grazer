 ...
 * topology. Before running this function, change into the directory containing
 * the grazer output folder.
 *
 * @param argc number of command line arguments
 * @param argv Relative or absolute path to the reference output
 * file, the name of the output filename (optional, defaults to "output") and
 * the name of the file to be generated by this helper
 * function (optional, defaults to "reference_discrepance.json")
 */
