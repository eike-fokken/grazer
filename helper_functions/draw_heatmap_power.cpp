 ...
 * @param argv the filename of the topoligy file, the filename of the output
 * file generated by grazer, the filename of the texfile to be written and the
 * scale_factor (optinal, defaults to 10). Note that the output file must
 * contain the results for the key "P" for every node of type "PQnode",
 * "PVnode", "Vphinode", "StochasticPQnode" and "ExternalPowerplant".
 */
