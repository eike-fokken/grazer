...
namespace Model::Networkproblem::Gas {
  ...
  void
  Shortcomponent::print_helper(std::filesystem::path const &output_directory,
    ...
    std::filesystem::path shortcomponent_output_pressure(output_directory /
                                                         pressure_file_name);
    std::filesystem::path shortcomponent_output_flow(output_directory /
                                                     flow_file_name);
  ...
  void
  Shortcomponent::save_values(double time,
  ...
  void
  Shortcomponent::initial_values_helper(Eigen::Ref<Eigen::VectorXd> new_state,
