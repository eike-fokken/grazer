...
namespace Model::Networkproblem::Gas {
  ...
  Gaspowerconnection::Gaspowerconnection(
      ...
      : Network::Edge(topology, nodes),
        gas2power_q_coefficient(topology["gas2power_q_coeff"]),
        power2gas_q_coefficient(topology["power2gas_q_coeff"]) {}
  ...
  void Gaspowerconnection::setup() {
    ...
    if (powernodeptr == nullptr) {
      gthrow({"An edge of type \"Gaspowerconnection\" can only end at a "
  ...
  void
  Gaspowerconnection::set_initial_values(Eigen::Ref<Eigen::VectorXd> new_state,
