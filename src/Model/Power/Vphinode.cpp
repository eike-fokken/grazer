...
void Vphinode::evaluate_state_derivative(Eigen::SparseMatrix<double> &jacobian,
                                         double // last_time
                                         ,
                                         double // new_time
                                         ,
  ...
  jacobian.coeffRef(start_index, start_index) = -1.0;
  jacobian.coeffRef(end_index, end_index) = -1.0;
}
