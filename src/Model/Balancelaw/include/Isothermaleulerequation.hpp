...
public:
  ...
  static Eigen::Vector2d source(Eigen::Vector2d const &state, double diameter,
                         double roughness);
  static Eigen::Matrix2d dsource_dstate(Eigen::Vector2d const &state, double diameter,
                                 double roughness);
  ...
  static Eigen::Vector2d p_qvol_from_p_qvol_bar(Eigen::Vector2d const &p_qvol_bar);

  static double p_bar_from_p_pascal(double p);
  static double dp_bar_from_p_pascal_dp_pascal(double p);

  static Eigen::Vector2d p_qvol_bar_from_p_qvol(Eigen::Vector2d const &p_qvol);
  static Eigen::Matrix2d dp_qvol_bar_from_p_qvold_p_qvol(Eigen::Vector2d const &p_qvol);
  ...
  static double lambda_non_laminar(double Re, double diameter, double roughness);
  static double dlambda_non_laminar_dRe(double Re, double diameter,
                                 double roughness);
  ...
  static double dSwamee_Jain_dRe(double Re, double diameter, double roughness);

  static double exact_turbulent_lambda(double Re, double diameter, double roughness);
