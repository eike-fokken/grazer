...
namespace Model::Balancelaw {
  ...
  public:
    Isothermaleulerequation(double _Area, double _diameter, double _roughness);
    ...
    Eigen::Vector2d
    p_qvol_from_p_qvol_bar(Eigen::Vector2d const &p_qvol_bar) const;
    ...
    Eigen::Matrix2d
    dp_qvol_bar_from_p_qvold_p_qvol(Eigen::Vector2d const &p_qvol) const;
