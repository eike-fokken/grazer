...
namespace Network {
  ...
  public:
    ...
    /// This function removes a node from the net by id by going through a
    /// vector of exiting nodes.
    ...
    /// a shared pointer of type <Network::Edge> given the corresponding nodes
    /// id. Mind the order!
