...
namespace Optimization {
  ...
  //   auto const &fine_times =
  //   fine_resolution_vector.get_interpolation_points(); auto const
  //   &coarse_times
  ...
  //   Eigen::Index inner_matrix_size =
  //   fine_resolution_vector.get_inner_length(); for (size_t i = 0; i !=
  //   fine_times.size(); ++i) {
  ...
  //     if (j == 0) {
  //       // This can only happen on the first of the fine time points,
  //       therefore
  //       // row and column index are 0 and lambda = 0.
  //       add_homotethy_triplets_at_index(triplets, 1.0, 0, 0,
  //       inner_matrix_size);
  //     } else {
  //       auto t = fine_times[i];
