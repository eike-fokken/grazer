...
TEST(testImplicitboxscheme, evaluate_point) {
  ...
  Model::Balancelaw::Isothermaleulerequation bl(Area, diameter, roughness);
  ...
  scheme.evaluate_point(result, last_time,
                  new_time,  Delta_x,
                 last_left,
                 last_right,
                 new_left,
...
TEST(testImplicitboxscheme, devaluate_point_dleft) {
  ...
  scheme.evaluate_point(result_h0, last_time,
                  new_time,  Delta_x,
                 last_left,
                 last_right,
                 new_left+h0,
  ...
  scheme.evaluate_point(result_mh0, last_time,
                        new_time,  Delta_x,
                        last_left,
                        last_right,
                        new_left -h0,
  ...
  Eigen::Matrix2d jacobimatrix = scheme.devaluate_point_dleft( last_time,  new_time, Delta_x,
                                last_left,
                                last_right,
                                new_left,
                                new_right,
  ...
  Eigen::Vector2d result_mh1;
    scheme.evaluate_point(result_h1, last_time,
                  new_time,  Delta_x,
                 last_left,
                 last_right,
                 new_left+h1,
  ...
  scheme.evaluate_point(result_mh1, last_time,
                        new_time,  Delta_x,
                        last_left,
                        last_right,
                        new_left -h1,
  ...
  Eigen::Matrix2d jacobimatrix1 = scheme.devaluate_point_dleft( last_time,  new_time, Delta_x,
                                last_left,
                                last_right,
                                new_left,
                                new_right,
...
TEST(testImplicitboxscheme, devaluate_point_dright) {
  ...
  Eigen::Matrix2d jacobimatrix = scheme.devaluate_point_dright( last_time,  new_time, Delta_x,
                                last_left,
                                last_right,
                                new_left,
                                new_right,
  ...
  Eigen::Matrix2d jacobimatrix1 = scheme.devaluate_point_dright( last_time,  new_time, Delta_x,
                                last_left,
                                last_right,
                                new_left,
                                new_right,
